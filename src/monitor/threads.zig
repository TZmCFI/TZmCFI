...
fn TCReset(_1: usize, _2: usize, _3: usize, _4: usize) callconv(.C) usize {
    init();
    return 0;
}

fn TCCreateThread(raw_p_create_info: usize, raw_p_thread: usize, _3: usize, _4: usize) callconv(.C) usize {
...
fn TCLockdown(_1: usize, _2: usize, _3: usize, _4: usize) callconv(.C) usize {
    @panic("unimplemented");
}

fn TCActivateThread(thread: usize, _2: usize, _3: usize, _4: usize) callconv(.C) usize {
